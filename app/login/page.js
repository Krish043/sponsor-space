    ...
    <div className="text-white py-12 container mx-auto">
      ...
      <div className="social-login-buttons">
        <div className="flex flex-col justify-cetner items-center gap-2 min-h-screen p-10">
          <button onClick={()=>{signIn("google")}} className="flex items-center w-64 text-black bg-slate-50 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
