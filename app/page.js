    ...
    <>
      <div className="flex justify-center items-center flex-col gap-4 h-[40vh] text-white">
        <div className="flex gap-5 items-center">
          <div className="font-bold text-5xl">
            Sponsor Space <span></span>
          </div>
          <Image
            className="text-black mt-4"
            width={58}
            height={58} // Specify height for optimization
            src="/logo.gif"
            alt="Sponsor Space Logo"
          />
        </div>
        <p>
      ...
      <div className="text-white container mx-auto py-12">
        <h1 className="text-2xl font-bold text-center my-8">
          Your fans can donate to you
        </h1>
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <Image
              className="bg-slate-400 rounded-full p-5 text-black"
              width={88}
              height={88} // Specify height for optimization
              src="/help.gif"
      ...
      <div className="text-white container mx-auto py-12">
        ...
        <div className="flex gap-5 justify-around">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/-XwZpYIyCEA?si=tSpTetinSNWvndd5"
