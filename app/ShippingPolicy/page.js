...
const ShippingPolicy = () => {
  return (
    <div className="m-12 p-8 rounded-lg shadow-md max-w-4xl mx-auto mt-10">
      ...
      <p className="text-white mb-6">
        We currently ship to addresses within [Country/Region]. We do not ship to P.O. Boxes or military addresses (APO/FPO).
      </p>
      ...
      <p className="text-white mb-6">
        We currently do not ship outside [Country/Region]. Any changes to our international shipping policy will be updated here.
      </p>

      <h2 className="text-2xl font-semibold text-slate-400 mb-4">9. Contact Us</h2>
      <p className="text-white mb-6">
        If you have any questions or concerns about this Shipping Policy, please contact us at <a href="mailto:support@sponsorspace.com" className="text-blue-400 underline">support@sponsorspace.com</a>.
      </p>
